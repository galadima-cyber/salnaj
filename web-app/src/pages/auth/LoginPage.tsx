...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--color-bg)' }}>
      ...
      <div
        className="hidden lg:flex lg:w-1/2 bg-primary-gradient flex-col justify-between p-12 relative overflow-hidden"
      >
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-20 right-10 w-64 h-64 rounded-full" style={{ background: 'rgba(255,255,255,0.06)', filter: 'blur(40px)' }} />
          <div className="absolute bottom-20 left-10 w-80 h-80 rounded-full" style={{ background: 'rgba(255,255,255,0.04)', filter: 'blur(60px)' }} />
        </div>
        ...
        <div className="w-full max-w-md animate-fadeInUp">
          ...
          <div className="mb-8">
            ...
            <p className="text-base" style={{ color: 'var(--color-text-secondary)' }}>
              ...
              <Link to="/register" className="font-600 hover:underline" style={{ color: 'var(--color-primary)', fontWeight: 600 }}>
                Sign up free
              </Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-xs hover:underline" style={{ color: 'var(--color-primary)' }}>
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-8 pt-6 flex items-center gap-3" style={{ borderTop: '1px solid var(--color-border)' }}>
            <p className="text-xs" style={{ color: 'var(--color-text-muted)' }}>
              Protected by 256-bit encryption. Your data is safe with us.
            </p>
          </div>
        </div>
      </div>
